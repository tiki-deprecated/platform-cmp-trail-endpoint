...
class BackupBlkObj {
  ...
  BackupBlkObj.deserialize(Uint8List serializedBackup)
      : signature = serializedBackup.sublist(0, 33),
        ...
        transactions = TransactionService.deserializeTransactions(serializedBackup.sublist(33));

  Uint8List serialize(KeysModel keys) {
    Uint8List body = TransactionService.staticTransactionsSerializer(transactions);
