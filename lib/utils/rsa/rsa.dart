...
class UtilsRsa {
  ...
  static Uint8List encrypt(CryptoRSAPublicKey key, Uint8List plaintext) {
  ...
  static Future<Uint8List> encryptAsync(
      CryptoRSAPublicKey key, Uint8List plaintext) {
    Map<String, String> q = {};
  ...
  static Uint8List decrypt(CryptoRSAPrivateKey key, Uint8List ciphertext) {
  ...
  static Uint8List sign(CryptoRSAPrivateKey key, Uint8List message) {
  ...
  static Future<Uint8List> signAsync(
      CryptoRSAPrivateKey key, Uint8List message) {
    Map<String, String> q = {};
