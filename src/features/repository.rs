...
use writer_body_transaction::WriterBodyTransaction;

mod writer_group;
use writer_group::WriterGroup;

mod repository_service;
mod writer_group_type;

use writer_group_type::WriterGroupType;
...
//         self.writer
//             .transaction(provider.as_str(), address.as_str(), transaction)
//             .await
//     }
//
...
//             .ok_or::<Box<dyn Error>>(Box::<dyn Error>::from("Address is None"))?;
//         self.reader
//             .metadata(provider.as_str(), address.as_str())
//             .await
//     }
//
...
//             .ok_or::<Box<dyn Error>>(Box::<dyn Error>::from("Address is None"))?;
//         self.reader
//             .block(provider.as_str(), address.as_str(), id)
//             .await
//     }
// }
